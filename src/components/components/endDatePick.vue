<template>
  <div>
    <input class="dateTimeInput"   v-model="startTimeValue"  style="font-size: 0.9rem" type="text" readonly="" id="demo2"  name="input_date" placeholder="请输入日期" data-lcalendar="2000-01-01,2020-01-01" />
  </div>
</template>
<script>
