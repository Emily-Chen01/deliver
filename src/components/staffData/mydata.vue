          ...
          <div v-if="selected==='1'">
            ...
            {message: `最多${item.characterLimit}个字`,max:item.characterLimit, trigger: 'blur'}
                  ...
                  <el-form-item v-if="item.fieldType===2" :label="item.remark" :prop="item.uid+'[0].value'"
                    ...
                    <p class="pl10" :class="{'fc-noValue':!staffInfoName[item.uid][0].value}" v-if="item.isedit"
            ...
            {message: `必须是大于0，小于或等于${Math.pow(10, item.characterLimit) - 1}的数字`,max:item.characterLimit, validator: isSize, trigger: 'blur'}
                  ...
                  <el-form-item v-if="item.fieldType===4" :label="item.remark" :prop="item.uid+'[0].value'"
                    ...
                    <select :disabled="!item.isedit" v-model="staffInfoName[item.uid][0].value"
                  ...
                  <el-form-item v-if="item.fieldType===7||item.fieldType===8" :label="item.remark"
                    ...
                    <el-button size="small"
                               ...
                               @click="resumeDel(item.uid,staffInfoName[item.uid].edit)" class="upload-img-delBtn">
                      <span>
                    ...
                    <div v-if="staffInfoName[item.uid].info.value.length && staffInfoName[item.uid].info.value[0].value"
                      ...
                      <div v-if="item.fieldType===7" v-for="(ite, idx) in staffInfoName[item.uid].info.value" :key="idx"
                           class="upload-img-box" @click="imageScaleOpen(ite.value,4,idx,item.uid)">
                        <img :src="ite.value"/>
                        <img src="../../assets/ico_select_1.png" class="upload-img-icon"
                             v-if="staffInfoName[item.uid].edit && !staffInfoName[item.uid].info.value[idx].state"
                             alt="">
                        <img src="../../assets/ico_select_2.png" class="upload-img-icon"
                             v-if="staffInfoName[item.uid].edit && staffInfoName[item.uid].info.value[idx].state"
                             alt="">
                      </div>
                      <div v-if="item.fieldType===8" v-for="(ite, idx) in staffInfoName[item.uid].info.value" :key="idx"
                           class="upload-img-box" @click="imageScaleOpen(ite.value,5,idx,item.uid)">
                ...
                <div v-else>
                  ...
                  <div v-else-if="item.jname==='nativePlace'">
                    ...
                    <el-form-item
                      ...
                      label="护照编号" :prop="item.jname+'.passportNum'" :rules="[{required: (item.isrequired || (staffInfoName[item.jname].nativePlace !== '0')),  message: '请填写护照号', trigger: 'change'},
                    ...
                    <el-form-item v-if="staffInfoName[item.jname].nativePlace === '2'" label="护照国家"
                                  :prop="item.jname+'.state'"
                  ...
                  <div v-else-if="item.jname==='politicsStatus'">
                    ...
                    <el-form-item v-if="staffInfoName[item.jname].politicsStatus === '2'" label="入党时间"
                      ...
                      <p class="pl10" :class="{'fc-noValue':!staffInfoName[item.jname].thePartyTime}" v-if="item.isedit"
                  ...
                  <div v-else-if="item.jname==='eduInfor'">
                    ...
                    <el-form-item label="入学日期" :prop="item.jname+'.entSchst'"
                      ...
                      <p class="pl10" :class="{'fc-noValue':!staffInfoName[item.jname].entSchst}" v-if="item.isedit"
                    ...
                    <el-form-item label="毕业日期" :prop="item.jname+'.entSchet'"
                      ...
                      <p class="pl10" :class="{'fc-noValue':!staffInfoName[item.jname].entSchet}" v-if="item.isedit"
                  ...
                  <div v-else-if="item.jname==='hasChilds'">
                    <el-form-item label="是否有子女">
                      <el-switch :disabled="!item.isedit" v-model="staffInfoName[item.jname].hasChild" on-text="有"
                                 off-text="无">
                      </el-switch>
                    </el-form-item>
                    <div class="child-box" v-if="staffInfoName[item.jname].hasChild">
                      <div class="child" v-for="(ite, idx) in staffInfoName[item.jname].childs" :key="idx">
                        <el-form-item label="子女姓名" :prop="item.jname+'.childs['+idx+'].name'" label-position="top"
                                      labelWidth="125px" :rules="[{required: item.isrequired, message: '请输入子女姓名', trigger: 'change'},
                        ...
                        <el-form-item label="子女出生日期" :prop="item.jname+'.childs['+idx+'].dateOfBirth'"
                          ...
                          <p class="pl10" :class="{'fc-noValue':!ite.dateOfBirth}" v-if="item.isedit"
                    ...
                    <el-form-item label-width="0" class="contact-box">
                      ...
                      <div class="contacts-wrapper">
                        <div class="contact" :span="24" v-for="(ite, idx) in staffInfoName[item.jname]" :key="idx">
                          <el-form-item label="姓名" label-width="4em" :prop="item.jname+'[' + idx + '].emergContact'"
                          ...
                          <el-form-item label="电话" label-width="4em"
                                        ...
                                        :rules="{required:item.isrequired,message: '请输入紧急联系人电话', trigger: 'blur'}">
                            <el-input :disabled="!item.isedit" placeholder="请输入联系电话"
                                      v-model="ite.emergContactPhone"></el-input>
                          </el-form-item>
                          <el-form-item label="关系" label-width="4em"
                                        :prop="item.jname+'[' + idx + '].emergContactRelation'"
                                        :rules="{required:item.isrequired,message: '请输入紧急联系人电话', trigger: 'blur'}">
                            <el-input :disabled="!item.isedit" placeholder="请输入关系"
                                      v-model="ite.emergContactRelation"></el-input>
                          </el-form-item>
                        </div>
                        <el-row>
                          <el-col align="center" :span="24">
                            <el-button :disabled="!item.isedit" v-if="staffInfoName[item.jname].length < 3"
                                       class="add-contact" size="small" type="primary" @click="addContact">
                              <span>添加紧急联系人</span>
                            </el-button>
                          </el-col>
                        </el-row>
                  ...
                  <div v-else-if="item.jname==='ResperMessage'">
                    <el-form-item label="居住证">
                      <el-switch :disabled="!item.isedit" v-model="staffInfoName[item.jname].hasResper" on-text="有"
                                 off-text="无">
                      </el-switch>
                    </el-form-item>
                    ...
                    <el-form-item v-if="staffInfoName[item.jname].hasResper" label="居住证办理时间"
                      ...
                      <p class="pl10" :class="{'fc-noValue':!staffInfoName[item.jname].resperst}" v-if="item.isedit"
                    ...
                    <el-form-item v-if="staffInfoName[item.jname].hasResper" label="居住证截止日期"
                      ...
                      <p class="pl10" :class="{'fc-noValue':!staffInfoName[item.jname].resperet}" v-if="item.isedit"
                  ...
                  <div v-else-if="item.jname==='bankName'">
                    ...
                    <el-form-item label="银行卡照片" :prop="item.jname+'.staffCardUrls'"
                      ...
                      <el-button size="small"
                                 ...
                                 @click="resumeDel('bankName.staffCardUrls','bankCardEdit')" class="upload-img-delBtn">
                        <span>
                          <i class="el-icon-delete"></i>删除</span>
                      </el-button>
                  ...
                  <div v-else-if="item.jname==='hasComres'">
                    <el-form-item label="是否有竞业协议">
                      <el-switch :disabled="!item.isedit" v-model="staffInfoName[item.jname].hasComres" on-text="有"
                                 off-text="无">
                      </el-switch>
                    </el-form-item>
                    <el-form-item v-if="staffInfoName[item.jname].hasComres" label="竞业协议备注"
                                  :prop="item.jname+'.hasComresRmk'" :rules="[{required: item.isrequired,message: '请输入备注信息', trigger: 'blur'},
                        {message: '不能超过32个字符', trigger: 'blur', max: 32}]">
                  ...
                  <div v-else-if="item.jname==='informUrl'">
                    <el-form-item :label="item.remark" prop="informUrl"
                      ...
                      <el-button size="small" v-if="item.isedit && !informEdit && staffInfoName[item.jname].length"
                                 @click="resumeDel('informUrl','informEdit')" class="upload-img-delBtn">
                        <span>
                          <i class="el-icon-delete"></i>删除</span>
                      </el-button>
                      ...
                      <div v-if="staffInfoName[item.jname].length" class="upload-img-wrapper">
                        <div v-for="(ite, idx) in staffInfoName[item.jname]" class="upload-img-box"
                          ...
                          <img :src="ite.url"/>
                          <img src="../../assets/ico_select_1.png" class="upload-img-icon"
                               v-if="informEdit && !staffInfoName[item.jname][idx].state" alt="">
                          <img src="../../assets/ico_select_2.png" class="upload-img-icon"
                               v-if="informEdit && staffInfoName[item.jname][idx].state" alt="">
                        </div>
                  ...
                  <div v-else-if="item.jname==='resumeUrl'">
                    <el-form-item :label="item.remark" prop="resumeUrl" :required="item.isrequired">
                      ...
                      <el-button size="small" v-if="item.isedit && !resumeEdit && staffInfoName[item.jname].length"
                                 @click="resumeDel('resumeUrl','resumeEdit')" class="upload-img-delBtn">
                        <span>
                          <i class="el-icon-delete"></i>删除</span>
                      </el-button>
                      ...
                      <div v-if="staffInfoName[item.jname].length" class="upload-img-wrapper">
                        <div v-for="(ite, idx) in staffInfoName[item.jname]" class="upload-img-box"
                          ...
                          <img :src="ite.url"/>
                          <img src="../../assets/ico_select_1.png" class="upload-img-icon"
                               v-if="resumeEdit && !staffInfoName[item.jname][idx].state" alt="">
                          <img src="../../assets/ico_select_2.png" class="upload-img-icon"
                               v-if="resumeEdit && staffInfoName[item.jname][idx].state" alt="">
                        </div>
                        <div v-for="(ite, idx) in staffInfoName[item.jname]" class="upload-img-box upload-img-box1"
                  ...
                  <div v-else>
                    <el-form-item :label="item.remark" :prop="item.jname"
                      ...
                      <el-input v-else-if="item.jname==='idcard'" :disabled="!item.isedit"
                                :placeholder="'请输入'+item.remark" @change="staffIdcard(staffInfoName[item.jname],true)"
                  ...
                  <el-form-item label="合同附件">
                    <div v-if="item.value.contractUrls.length&&item.value.contractUrls[0].url"
                      ...
                      <div v-for="(ite, idx) in item.value.contractUrls" :key="idx"
                           class="upload-img-box upload-img-box1" @click="imageScaleOpen(ite.url,0,0)"
                           v-if="!(isFormatImg(ite.url))">
                        <div v-if="!(isFormatImg(ite.url))" class="upload-document-box">
    ...
    data() {
      return {
        ...
        rulesStaffInfoName: {
          ...
          englishName: [
            {message: "请填写正确的英文名", trigger: "blur"},
