    ...
    <mt-tab-container v-model="selected">
      <mt-tab-container-item id="1">
        ...
        <el-form label-position="left" :model="model" :rules="rules" :label-width="labelWidth"
          ...
          <div v-for="confListItem in confList" v-if="confListItem.isdefault===true">
            ...
            <div v-else-if="confListItem.jname==='mobile'">
            ...
            <div v-else-if="confListItem.jname==='gender'">
            ...
            <div v-else-if="confListItem.jname==='dateOfBirth'">
            ...
            <div v-else-if="confListItem.jname==='idcard'">
            ...
            <div v-else-if="confListItem.jname==='podoMessage'">
              ...
              <el-form-item v-if="staff.podoMessage" label="户口省份" prop="podoProvince"
                ...
                <el-select :disabled="!staff.podoMessage.isedit" clearable v-model="model.podoProvince"
                           placeholder="请选择"
              ...
              <el-form-item v-if="staff.podoMessage" label="户口性质" prop="typeOfDemicile"
                ...
                <el-select :disabled="!staff.podoMessage.isedit" clearable v-model="model.typeOfDemicile"
                           placeholder="请选择">
                  <el-option
          ...
          <div v-for="confListItem in confList" v-if="confListItem.isdefault===false">
            <div v-if="confListItem.jname==='nativePlace'">
            ...
            <div v-else-if="confListItem.jname==='idcardPhoUrl'">
            ...
            <div v-else-if="confListItem.jname==='socsecNum'">
            ...
            <div v-else-if="confListItem.jname==='accfuNum'">
            ...
            <div v-else-if="confListItem.jname==='bankName'">
            ...
            <div v-else-if="confListItem.jname==='staffPhoUrl'">
            ...
            <div v-else-if="confListItem.jname==='englishName'">
            ...
            <div v-else-if="confListItem.jname==='qq'">
            ...
            <div v-else-if="confListItem.jname==='wechart'">
            ...
            <div v-else-if="confListItem.jname==='maritalStatus'">
            ...
            <div v-else-if="confListItem.jname==='nation'">
            ...
            <div v-else-if="confListItem.jname==='politicsStatus'">
            ...
            <div v-else-if="confListItem.jname==='theArcIns'">
            ...
            <div v-else-if="confListItem.jname==='houregPhoUrl'">
            ...
            <div v-else-if="confListItem.jname==='ResperMessage'">
            ...
            <div v-else-if="confListItem.jname==='poreLocation'">
            ...
            <div v-else-if="confListItem.jname==='personalEmail'">
            ...
            <div v-else-if="confListItem.jname==='emergencyContact'">
            ...
            <div v-else-if="confListItem.jname==='hasChilds'">
            ...
            <div v-else-if="confListItem.jname==='finallyEmpCom'">
            ...
            <div v-else-if="confListItem.jname==='eduInfor'">
              ...
              <el-form-item v-if="staff.eduInfor" label="学历类型" prop="diplomaType"
                ...
                <el-select :disabled="!staff.eduInfor.isedit" clearable v-model="model.diplomaType"
                           placeholder="请选择学历类型">
                  <el-option
            ...
            <div v-else-if="confListItem.jname==='technicalTitle'">
            ...
            <div v-else-if="confListItem.jname==='resumeUrl'">
            ...
            <div v-else-if="confListItem.jname==='hasComres'">
            ...
            <div v-else-if="confListItem.jname==='emplsepacertUrl'">
      ...
      <mt-tab-container-item id="2">
        <el-form label-position="left" :model="model" :rules="rules" ref="postFm" :label-width="labelWidth">
          <div v-for="confListItem in confList" v-if="confListItem.isdefault===true">
            <div v-if="confListItem.jname==='contracMes'">
            ...
            <div v-else-if="confListItem.jname==='jobNumber'">
              <el-form-item v-if="staffRecord.jobNumber" label="工号">
                <span>{{model.record.jobNumber}}</span>
              </el-form-item>
            </div>
            <div v-else-if="confListItem.jname==='StaffStatus'">
            ...
            <div v-else-if="confListItem.jname==='reporterJobNumber'">
          ...
          <div v-for="confListItem in confList" v-if="confListItem.isdefault===false">
            <div v-if="confListItem.jname==='workLocation'">
            ...
            <div v-else-if="confListItem.jname==='workEmail'">
